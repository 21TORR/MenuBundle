...
use Torr\MenuBundle\Sorter\MenuItemSorter;
...
class MenuItem
{
	 ...
	 */
	private array $listItemAttributes = [];


	/**
	 * @var string[]
	 */
	private array $listItemClasses = [];
	 ...
	 */
	private array $childListAttributes = [];


	/**
	 * @var string[]
	 */
	private array $childListClasses = [];
	 ...
	 * null         -> no link
	 */
	private LazyRoute|string|null $target = null;
	 ...
	 */
	private bool $currentAncestor = false;
	...
	public function setListItemAttribute (string $name, mixed $value) : self
	{
	...
	public function setLinkAttribute (string $name, mixed $value) : self
	{
	...
	public function setChildListAttribute (string $name, mixed $value) : self
	{
	 ...
	 * @return mixed
	 */
	public function getExtra (string $name, mixed $defaultValue = null)
	{
	...
	public function resolveTree (string $currentClass = "current", string $ancestorClass = "ancestor", int $level = 0) : bool
	{
		...
		$this
			...
			->addChildListClass(sprintf("menu-level-%d", $level));
